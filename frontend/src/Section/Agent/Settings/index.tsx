...
import { editProfileImg, getUserDeatails } from "../../../service/api/agent/apiMethod";
...
const getDetails=()=>{
  ...
  const getCroppedFile = (croppedData: string) => {
    ...
    editProfileImg(agent.agentId,croppedData)
  ...
  <button className="agent_button  h-8 pt-1" onClick={() => setShowModal1(true)}  >Edit Profile</button>
</div>
    </div>
</div>
